...
- (void)executeBatchDownloadWithFileArray:(NSArray *)fileArray{
    ...
    [self.batchDownload executeWithFileArray:fileArray globalProgress:^(NSString *globalProgress) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            downloadInfoView.downloadInfoLabel.textColor = [UIColor blackColor];
        });
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            downloadInfoView.progressLabel.textColor = [UIColor blackColor];
            downloadInfoView.progressLabel2.textColor = [UIColor blackColor];
        });
